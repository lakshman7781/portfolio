      ...
      <section className="min-h-screen px-4 py-16 bg-transparent relative z-10">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="bg-gray-900/70 backdrop-blur-sm border border-gray-800 p-8 rounded-xl shadow-lg transition-all duration-300 hover:shadow-[0_0_15px_rgba(0,255,0,0.2)]">
              ...
              <form className="space-y-6">
                <div>
                  ...
                  <input
                    type="text"
                    id="name"
                    className="w-full px-4 py-2 bg-gray-800/80 border border-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-[#00ff00]/50 focus:border-[#00ff00]/50 transition-all"
                ...
                <button
                  type="submit"
                  className="w-full px-6 py-3 bg-[#00ff00]/20 text-[#00ff00] border border-[#00ff00]/30 font-medium rounded-md hover:bg-[#00ff00]/30 transition-all duration-300 hover:shadow-[0_0_10px_rgba(0,255,0,0.3)] group"
                >
            ...
            <div className="bg-gray-900/70 backdrop-blur-sm border border-gray-800 p-8 rounded-xl shadow-lg transition-all duration-300 hover:shadow-[0_0_15px_rgba(0,255,0,0.2)]">
              ...
              <div className="space-y-6">
                <div className="transition-all duration-300 hover:translate-x-2">
                  ...
                  <p className="text-[#00ff00]">contact@lakshmanreddy.com</p>
                </div>
                ...
                <div>
                  <h3 className="text-lg font-medium text-gray-300 mb-4">Social Media</h3>
                  <div className="flex space-x-4">
                    <a href="#" className="text-gray-400 hover:text-[#00ff00] transition-colors hover:scale-110 transform duration-300">
